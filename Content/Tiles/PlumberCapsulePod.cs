...
public class PlumberCapsulePod : ModTile {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            if (player.HeldItem.ModItem is not PlumbersBadge badge)
                return false;

            if (Ben10FeatureBlacklistRegistry.IsFeatureBlacklisted(Ben10FeatureType.PlumbersBadge, badge.Mod) ||
                Ben10FeatureBlacklistRegistry.IsFeatureBlacklisted(Ben10FeatureType.Omnitrix,
