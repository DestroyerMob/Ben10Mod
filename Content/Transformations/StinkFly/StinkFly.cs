...
namespace Ben10Mod.Content.Transformations.StinkFly
{
    public class StinkFly : ModItem {
        ...
        public override bool CanUseItem(Player player) => !TransformationHandler.HasTransformation(player, TransformationEnum.StinkFly);

        public override bool? UseItem(Player player) {
            player.GetModPlayer<OmnitrixPlayer>().unlockedTransformation.Add(TransformationEnum.StinkFly);
            return true;
        }
    }
