...
public class WhampireNightSwarmProjectile : ModProjectile {
            ...
            if ((int)Projectile.localAI[1] % 24 == 0) {
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), spawnPosition, velocity,
                        ...
                        Projectile.owner, Cloaked ? 1f : 0f, PreyTargetIndex + 1f);
                }
            }
        }
    ...
    public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox) {
        return targetHitbox.Distance(Projectile.Center) <= GetCurrentRadius();
    }
    ...
    private void FollowMarkedPrey() {
        ...
        Projectile.Center = Vector2.Lerp(Projectile.Center, preyTarget.Center, 0.16f);
    }

    private void HarassNPCs(float currentRadius) {
    ...
    private float GetCurrentRadius() {
        ...
        return MathHelper.Lerp(Cloaked ? 110f : 96f, Cloaked ? 172f : 154f, pulse);
    }
