...
public class AmpFibianBurstProjectile : ModProjectile {
    ...
    public override void AI() {
        ...
        Lighting.AddLight(Projectile.Center, new Vector3(0.15f, 0.36f, 0.72f));
    }
    ...
    private void SpawnBurstDust(float radius, float previousRadius) {
        ...
        int points = Math.Max(8, (int)Math.Round(radius / 9f));
        ...
        for (int i = 0; i < points; i++) {
            ...
            Vector2 velocity = direction * Main.rand.NextFloat(0.6f, 2.4f);

            Dust dust = Dust.NewDustPerfect(position, i % 3 == 0 ? DustID.BlueTorch : DustID.Electric, velocity, 105,
                Color.Lerp(new Color(90, 190, 255), new Color(210, 250, 255), Main.rand.NextFloat()),
