...
public class BigChillGraveMistProjectile : ModProjectile {
    ...
    private int MaxLifetime => IsTrail ? (AbsoluteZero ? 75 : 60) : (AbsoluteZero ? 7 * 60 : 6 * 60);
    private float MaxRadius => IsTrail ? (AbsoluteZero ? 56f : 44f) : (AbsoluteZero ? 132f : 108f);
    ...
    public override void AI() {
        ...
        Lighting.AddLight(Projectile.Center,
            AbsoluteZero ? new Vector3(0.22f, 0.44f, 0.7f) : new Vector3(0.14f, 0.32f, 0.58f));
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
        target.velocity *= IsTrail ? 0.88f : 0.8f;
    ...
    public override bool PreDraw(ref Color lightColor) {
        ...
        DrawRing(pixel, center, CurrentRadius * 0.82f, IsTrail ? 3.8f : 4.8f,
            (AbsoluteZero ? new Color(126, 215, 255, 96) : new Color(112, 194, 255, 82)) * opacity, Projectile.rotation);
        DrawRing(pixel, center, CurrentRadius * 0.54f, IsTrail ? 3.2f : 4f,
            (AbsoluteZero ? new Color(186, 245, 255, 104) : new Color(172, 232, 255, 94)) * opacity, -Projectile.rotation * 1.2f);
        DrawRing(pixel, center, CurrentRadius * 0.28f, IsTrail ? 2.4f : 3.2f,
            (AbsoluteZero ? new Color(230, 250, 255, 110) : new Color(218, 244, 255, 102)) * opacity, Projectile.rotation * 1.6f);
        return false;
    }
    ...
    private void SlowHostileProjectiles() {
        ...
        for (int i = 0; i < Main.maxProjectiles; i++) {
            ...
            other.velocity *= IsTrail ? 0.985f : 0.972f;
        }
    }
    ...
    private void SpawnMistDust() {
        ...
        for (int i = 0; i < attempts; i++) {
            ...
            Dust dust = Dust.NewDustPerfect(Projectile.Center + offset,
                ...
                105, AbsoluteZero ? new Color(190, 240, 255) : new Color(168, 225, 255),
